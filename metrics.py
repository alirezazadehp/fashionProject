...
class ArcFace(Layer):
    def __init__(self, n_classes=6, s=30.0, m=0.05, regularizer=None, **kwargs):
    ...
    def call(self, inputs):
        ...
        #
        logits = logits * (1 - y) + logits * y #+ abs(target_logits1 - target_logits)
        # feature re-scale
        logits *= self.s
...
class CosFace(Layer):
    def __init__(self, n_classes=4, s=30.0, m=0.35, regularizer=None, **kwargs):
